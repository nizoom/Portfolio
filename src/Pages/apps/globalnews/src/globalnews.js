    ...
    <div className={classes.root}>
      <Grid container>
        <Grid item xs={12}>
          <Typography
            variant="h2"
            className={`${classes.typographyStyle} ${classes.h2MediaQueries}`}
            component={"div"}
          >
          ...
          <Typography
            variant="h4"
            className={`${classes.typographyStyle} ${classes.h4MediaQueries}`}
            component={"div"}
          >
            {" "}
        ...
        {page === 2 ? (
          <Grid item xs={12} className={classes.allItems}>
            <div className="map-instruction-wrapper">
              <p className="dropdown-label map-instruction">
                {" "}
                <img src={CircledTwo} className="numbers" alt="step-2" /> and 👇
                a point on the map{" "}
              </p>
            </div>
            <Map
              topicFilter={input}
              localityStatus={checkboxState.Localize}
