...
const AddMarker = (props) => {
  ...
  useMapEvents({
    ...
    click: (e) => {
      ...
      getPlaceName(e.latlng, props.userFilter, props.localityStatus).then(
        (response) => {
          ...
          if (response.length < 2) {
            ...
            let country =
              countryObj.length > 0 ? countryObj[0].long_name : null;
            ...
            let localArea =
              localAreaResults.length > 0
                ? localAreaResults[0].long_name
                : null;
